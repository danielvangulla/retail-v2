                ...
                <div className="info-section">
                    <div>
                        <div className="info-row">
                            <span className="info-label">Tgl Retur:</span>
                            <span className="info-value">{formatTgl(data.created_at)}</span>
                        </div>
                        <div className="info-row">
                    ...
                    <div>
                        ...
                        {data.ket && (
                            <div className="info-row">
                                ...
                                <span className="info-value">{data.ket}</span>
                            </div>
                        )}
                    </div>
                </div>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th className="text-right" style={{ width: '12.5%' }}>Harga</th>
                            <th className="text-right" style={{ width: '12.5%' }}>Total</th>
                        </tr>
                    </thead>
                    <tbody>
