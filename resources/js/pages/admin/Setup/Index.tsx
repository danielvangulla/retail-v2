                ...
                <div className="min-h-screen bg-linear-to-br from-blue-50 via-purple-50 to-pink-50 p-4 sm:p-6">
                    ...
                    <div className="mb-6 sm:mb-8">
                        <div className="flex items-center gap-3 mb-2">
                            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-linear-to-br from-blue-400 to-blue-500 flex items-center justify-center">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mt-8 flex gap-3 justify-end">
                                ...
                                <button
                                    type="submit"
                                    disabled={isLoading}
                                    className="px-4 sm:px-6 py-2.5 rounded-lg bg-linear-to-r from-blue-600 to-blue-500 text-white font-medium hover:from-blue-500 hover:to-blue-400 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center gap-2"
                                >
                                    {isLoading ? (
                                        <>
